...
@MultipartConfig
public class EventVolunteersLookupServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String result = connection.getDAO().getJSONEventVolunteers(connection, EventType.valueOf(eventType), eventId);
